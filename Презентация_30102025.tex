...
% ---------------------------------------------------------------------------->
\section{AF}
\begin{frame}\frametitle{Научный задел}
\begin{minipage}[0.4\textheight]{\textwidth}
\begin{columns}[T]
